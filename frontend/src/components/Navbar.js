      ...
      <nav className={`bg-white/95 backdrop-blur-md border-b sticky top-0 z-50 transition-all duration-300 ${
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-18 md:h-20">
            ...
            <div className="hidden lg:flex items-center gap-1">
              {navLinks.map((link) => (
                <button
                  ...
                  className="relative text-sm font-semibold text-gray-700 hover:text-accent transition-all duration-300 px-4 py-2.5 rounded-lg hover:bg-gradient-to-r hover:from-accent/5 hover:to-accent/10 group"
                >
            ...
            {/* Right Section - Contact & Actions - Enhanced */}
            <div className="flex items-center gap-3">
              {/* Social Links - Desktop Only - Enhanced */}
              <div className="hidden xl:flex items-center gap-2 mr-2">
                <a
                  href="tel:+447777998381"
                  className="relative w-10 h-10 rounded-xl bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center text-gray-700 hover:text-white transition-all duration-300 hover:scale-110 hover:shadow-lg group overflow-hidden"
                  aria-label="Call us"
                >
                ...
                <a
                  ...
                  className="relative w-10 h-10 rounded-xl bg-gradient-to-br from-green-50 to-green-100 flex items-center justify-center text-green-600 hover:text-white transition-all duration-300 hover:scale-110 hover:shadow-lg group overflow-hidden"
                  target="_blank"
                ...
                <a
                  ...
                  className="relative w-10 h-10 rounded-xl bg-gradient-to-br from-pink-50 to-pink-100 flex items-center justify-center text-pink-600 hover:text-white transition-all duration-300 hover:scale-110 hover:shadow-lg group overflow-hidden"
                  target="_blank"
                  rel="noopener noreferrer"
        ...
        <div className={`lg:hidden bg-gradient-to-b from-white to-gray-50/50 border-t border-gray-200 backdrop-blur-sm transition-all duration-300 overflow-hidden ${
            ...
            <div className="flex flex-col gap-1.5">
              {navLinks.map((link) => (
                <button
                  key={link.id}
                  onClick={() => scrollToSection(link.id)}
                  className="text-left text-base font-semibold text-gray-700 hover:text-accent hover:bg-gradient-to-r hover:from-accent/10 hover:to-accent/5 transition-all duration-300 py-3 px-4 rounded-xl hover:translate-x-1"
                >
                  {link.label}
                </button>
              ))}
              ...
              {/* Logout Button in Mobile Menu - Enhanced */}
              {isAuthenticated && (
                <button
                  onClick={handleLogout}
                  className="text-left text-base font-semibold text-gray-700 hover:text-red-600 hover:bg-gradient-to-r hover:from-red-50 hover:to-red-50/50 transition-all duration-300 py-3 px-4 rounded-xl flex items-center gap-2 hover:translate-x-1"
                >
              ...
              <div className="border-t border-gray-200 pt-4 mt-2">
                <div className="flex items-center gap-2 mb-4">
                  <a
                    href="tel:+447777998381"
                    className="flex items-center gap-2.5 text-gray-700 hover:text-accent transition-all duration-300 hover:scale-105 font-semibold"
                  >
                ...
                <div className="flex items-center gap-3">
                  <a
                    href="https://wa.me/447777998381"
                    className="relative w-11 h-11 rounded-xl bg-gradient-to-br from-green-50 to-green-100 flex items-center justify-center text-green-600 hover:text-white transition-all duration-300 hover:scale-110 hover:shadow-lg group overflow-hidden"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <div className="absolute inset-0 bg-gradient-to-br from-green-500 to-green-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  ...
                  <a
                    href="https://instagram.com/abdulb05"
                    className="relative w-11 h-11 rounded-xl bg-gradient-to-br from-pink-50 to-pink-100 flex items-center justify-center text-pink-600 hover:text-white transition-all duration-300 hover:scale-110 hover:shadow-lg group overflow-hidden"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <div className="absolute inset-0 bg-gradient-to-br from-pink-500 via-purple-500 to-pink-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  ...
                  <a
                    ...
                    className="relative w-11 h-11 rounded-xl bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center text-gray-600 hover:text-white transition-all duration-300 hover:scale-110 hover:shadow-lg group overflow-hidden"
                  >
