...
const Hero = () => {
  ...
  return (
    <section ref={sectionRef} id="home" className="relative py-6 sm:py-8 md:py-12 pb-16 sm:pb-20 md:pb-28 bg-gradient-to-br from-background-alt via-white to-background-alt overflow-hidden w-full">
      ...
      <div className="max-w-[1400px] mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative z-10 w-full overflow-x-hidden">
        <div className="grid grid-cols-1 md:grid-cols-[1.2fr_0.8fr] gap-6 sm:gap-8 md:gap-12 lg:gap-16 items-center w-full">
          <div className="relative z-10">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-[58px] 2xl:text-[64px] font-extrabold leading-tight text-primary mb-4 sm:mb-5 md:mb-7 tracking-tight animate-fade-in-up break-words" style={{ animationDelay: '0.1s' }}>
              Expert Heating &{' '}
              <span className="text-accent">Plumbing Services</span>
            </h1>
            <p className="text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed text-text-light mb-6 sm:mb-8 md:mb-10 max-w-full md:max-w-[650px] animate-fade-in-up break-words" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3 mb-6 sm:mb-8 md:mb-10">
              <div className="flex items-center gap-1.5 sm:gap-2 bg-accent/10 px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg border border-accent/20 hover-lift animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
                <FaCheckCircle className="text-accent flex-shrink-0" size={14} style={{ fontSize: 'clamp(14px, 2vw, 16px)' }} />
                <span className="text-xs sm:text-sm font-semibold text-primary whitespace-nowrap">15+ Years Experience</span>
              </div>
              <div className="flex items-center gap-1.5 sm:gap-2 bg-accent/10 px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg border border-accent/20 hover-lift animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                <FaStar className="text-accent flex-shrink-0" size={14} style={{ fontSize: 'clamp(14px, 2vw, 16px)' }} />
                <span className="text-xs sm:text-sm font-semibold text-primary whitespace-nowrap">5 Star Rated</span>
              </div>
              <div className="flex items-center gap-1.5 sm:gap-2 bg-accent/10 px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg border border-accent/20 hover-lift animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
                <FaAward className="text-accent flex-shrink-0" size={14} style={{ fontSize: 'clamp(14px, 2vw, 16px)' }} />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 md:gap-8 border-t border-border pt-6 sm:pt-8 md:pt-10 w-full">
              <div className="text-center sm:text-left group">
                <div className="flex items-center justify-center sm:justify-start gap-2 sm:gap-3 mb-2 sm:mb-3">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-accent/10 rounded-lg flex items-center justify-center group-hover:bg-accent transition-colors flex-shrink-0">
                    <FaShieldAlt className="text-accent group-hover:text-white" size={18} style={{ fontSize: 'clamp(18px, 2.5vw, 20px)' }} />
                  </div>
              ...
              <div className="text-center sm:text-left group">
                <div className="flex items-center justify-center sm:justify-start gap-2 sm:gap-3 mb-2 sm:mb-3">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-accent/10 rounded-lg flex items-center justify-center group-hover:bg-accent transition-colors flex-shrink-0">
                    <FaClock className="text-accent group-hover:text-white" size={18} style={{ fontSize: 'clamp(18px, 2.5vw, 20px)' }} />
                  </div>
                  <div className="min-w-0">
              ...
              <div className="text-center sm:text-left group">
                <div className="flex items-center justify-center sm:justify-start gap-2 sm:gap-3 mb-2 sm:mb-3">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-accent/10 rounded-lg flex items-center justify-center group-hover:bg-accent transition-colors flex-shrink-0">
                    <FaCheckCircle className="text-accent group-hover:text-white" size={18} style={{ fontSize: 'clamp(18px, 2.5vw, 20px)' }} />
                  </div>
                  <div className="min-w-0">
                    <div className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-primary leading-tight">
                      100%
          ...
          {/* Hero Image */}
          <div className="relative order-first md:order-last animate-fade-in-right w-full" style={{ animationDelay: '0.3s' }}>
            <div className="relative overflow-hidden rounded-xl sm:rounded-2xl shadow-2xl group hover-lift w-full">
              ...
              <img 
                ...
                className="w-full h-auto block transition-transform duration-700 group-hover:scale-110 object-cover max-w-full"
                loading="eager"
              />
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-primary/90 to-transparent p-4 sm:p-5 md:p-6 z-20 animate-fade-in-up">
                <div className="flex items-center gap-2 sm:gap-3 text-white">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-accent rounded-lg flex items-center justify-center animate-pulse-slow flex-shrink-0">
                    <FaWrench size={18} style={{ fontSize: 'clamp(18px, 2.5vw, 20px)' }} />
                  </div>
                  <div className="min-w-0">
            ...
            <div className="absolute -bottom-2 sm:-bottom-4 -right-2 sm:-right-4 bg-accent text-white px-4 sm:px-5 md:px-6 py-3 sm:py-3.5 md:py-4 rounded-lg sm:rounded-xl shadow-xl z-30 flex items-center gap-2 sm:gap-3 animate-bounce-slow hover-lift max-w-[calc(100%-1rem)] sm:max-w-none">
              <FaStar size={16} className="sm:w-5 sm:h-5 animate-pulse-slow flex-shrink-0" style={{ fontSize: 'clamp(16px, 2.5vw, 20px)' }} />
              <div className="min-w-0">
