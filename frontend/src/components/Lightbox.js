  ...
  return (
    ...
    >
      <button
        ...
        className="absolute top-2 right-2 sm:top-5 sm:right-5 bg-white/95 border-none text-primary w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center cursor-pointer transition-all text-xl sm:text-2xl font-bold rounded-full shadow-lg hover:bg-accent hover:text-white z-10"
        aria-label="Close"
      >
        <FaTimes />
      </button>
      <button
        onClick={prevImage}
        className="absolute left-2 sm:left-5 top-1/2 -translate-y-1/2 bg-white/95 border-none text-primary w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center cursor-pointer transition-all text-xl sm:text-2xl font-bold rounded-full shadow-lg hover:bg-accent hover:text-white z-10"
        aria-label="Previous"
      >
        <FaChevronLeft />
      </button>
      <button
        onClick={nextImage}
        className="absolute right-2 sm:right-5 top-1/2 -translate-y-1/2 bg-white/95 border-none text-primary w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center cursor-pointer transition-all text-xl sm:text-2xl font-bold rounded-full shadow-lg hover:bg-accent hover:text-white z-10"
        aria-label="Next"
      >
        <FaChevronRight />
      </button>
