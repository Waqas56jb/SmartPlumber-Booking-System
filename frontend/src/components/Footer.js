...
const Footer = () => {
  ...
  const services = [
    { name: 'Boiler Installations', href: '#services' },
    { name: 'Boiler Repairs', href: '#services' },
    { name: 'Central Heating', href: '#services' },
    { name: 'General Plumbing', href: '#services' },
    { name: 'Gas Safety Inspections', href: '#services' },
    { name: 'Leak Detection', href: '#services' },
    { name: 'Power Flushing', href: '#services' },
  ...
  const socialLinks = [
    { icon: FaWhatsapp, href: 'https://wa.me/447777998381', color: 'hover:text-whatsapp' },
    { icon: FaInstagram, href: 'https://instagram.com/abdulb05', color: 'hover:text-instagram' },
  ...
  return (
    <footer className="bg-gradient-to-br from-primary via-secondary to-primary text-white/90 relative overflow-hidden w-full">
      ...
      <div className="absolute top-0 left-0 w-full h-full opacity-10">
        ...
        <div className="absolute bottom-20 right-10 w-32 h-32 border-2 border-accent rounded-full animate-pulse-slow" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-48 h-48 border border-accent rounded-full animate-pulse-slow" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="max-w-[1400px] mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-16 sm:py-20 md:py-24 relative z-10 w-full overflow-x-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 sm:gap-10 mb-12 sm:mb-16">
            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3 mb-6">
                  <div className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-lg hover-lift animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
                    <FaCertificate className="text-accent" size={16} />
                    <span className="text-xs sm:text-sm font-semibold">Gas Safe Registered</span>
                  </div>
                  <div className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-lg hover-lift animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                    <FaAward className="text-accent" size={16} />
                    <span className="text-xs sm:text-sm font-semibold">15+ Years Experience</span>
                  </div>
                  <div className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-lg hover-lift animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
                  ...
                  {socialLinks.map((social, index) => {
                    ...
                    return (
                      <a
                        ...
                        className={`w-11 h-11 rounded-lg bg-white/10 flex items-center justify-center text-white/80 ${social.color} transition-all duration-300 hover:bg-accent hover:scale-110 hover:text-white shadow-lg hover-lift animate-fade-in-up`}
          ...
          {/* Quick Contact */}
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 sm:p-8 border border-white/20 shadow-2xl hover-lift animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="space-y-4">
              <a href="tel:+447777998381" className="flex items-center gap-3 text-white/90 hover:text-accent transition-all duration-300 group animate-fade-in-left hover-lift p-3 rounded-lg hover:bg-white/5" style={{ animationDelay: '0.5s' }}>
              ...
              <a href="mailto:basitpk4@yahoo.com" className="flex items-center gap-3 text-white/90 hover:text-accent transition-all duration-300 group animate-fade-in-left hover-lift p-3 rounded-lg hover:bg-white/5" style={{ animationDelay: '0.6s' }}>
                <div className="w-12 h-12 rounded-xl bg-accent/20 flex items-center justify-center flex-shrink-0 group-hover:bg-accent group-hover:scale-110 transition-all duration-300">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 mb-12">
            ...
            <ul className="flex flex-col gap-3 sm:gap-3.5 list-none">
              {services.map((service, index) => (
                <li key={index} className="animate-fade-in-left" style={{ animationDelay: `${0.3 + index * 0.05}s` }}>
                  <a 
                    href={service.href} 
                    className="text-sm sm:text-[15px] text-white/70 hover:text-accent transition-all duration-300 flex items-center gap-3 group hover:translate-x-1"
                  >
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
            ...
            <ul className="flex flex-col gap-4 sm:gap-5 list-none">
              <li className="flex items-start gap-3 group animate-fade-in-left hover-lift" style={{ animationDelay: '0.5s' }}>
              ...
              <li className="flex items-start gap-3 group animate-fade-in-left hover-lift" style={{ animationDelay: '0.6s' }}>
                <div className="w-11 h-11 rounded-lg bg-accent/20 flex items-center justify-center flex-shrink-0 group-hover:bg-accent transition-colors duration-300">
                  <FaEnvelope className="text-accent group-hover:text-white transition-colors duration-300" size={18} />
                </div>
                <div>
              ...
              <li className="flex items-start gap-3 group animate-fade-in-left hover-lift" style={{ animationDelay: '0.7s' }}>
                <div className="w-11 h-11 rounded-lg bg-accent/20 flex items-center justify-center flex-shrink-0 group-hover:bg-accent transition-colors duration-300">
              ...
              <li className="flex items-start gap-3 group animate-fade-in-left hover-lift" style={{ animationDelay: '0.8s' }}>
                <div className="w-11 h-11 rounded-lg bg-accent/20 flex items-center justify-center flex-shrink-0 group-hover:bg-accent transition-colors duration-300">
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8 py-6 sm:py-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-wrap justify-center gap-3 sm:gap-5 text-xs sm:text-sm">
              <button onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="text-white/70 hover:text-accent transition-all duration-300 font-medium flex items-center gap-1 bg-transparent border-none cursor-pointer hover:translate-y-[-2px]">
