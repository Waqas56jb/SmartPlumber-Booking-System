        ...
        background: 'linear-gradient(to bottom, #FEFEFE, #F5E6D3)'
          ...
          <div className="w-full max-w-sm bg-white/80 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-4 sm:p-5 md:p-6 lg:p-7 shadow-2xl flex flex-col mt-20 sm:mt-24 lg:mt-0">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5 flex-1 flex flex-col">
              {}
              {message.text && <div className={`flex items-center gap-2 p-3 rounded-lg text-sm font-medium animate-fade-in ${message.type === 'success' ? 'bg-green-50 text-green-700 border border-green-200' : 'bg-red-50 text-red-700 border border-red-200'}`}>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="email" id="email" name="email" value={formData.email} onChange={handleChange} placeholder="Enter your email address" className="w-full pl-9 sm:pl-10 md:pl-12 pr-3 sm:pr-4 h-11 sm:h-12 text-sm sm:text-base bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 transition-all duration-300 text-gray-900 placeholder:text-gray-400 shadow-sm" style={{
              ...
              <div className="flex items-center justify-end">
                <Link to="/forgot-password" className="text-xs sm:text-sm font-medium transition-colors" style={{
                color: '#D2A752'
              ...
              <div className="text-center pt-4 mt-auto">
                <p className="text-xs sm:text-sm text-gray-500">
                  ...
                  <Link to="/signup" className="font-semibold transition-colors" style={{
                  color: '#D2A752'
                }} onMouseEnter={e => e.target.style.color = '#B8943F'} onMouseLeave={e => e.target.style.color = '#D2A752'}>
                    Sign Up
                  </Link>
