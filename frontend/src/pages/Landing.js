...
const Landing = () => {
  ...
  const benefits = ["Quick and easy booking process", "Multiple payment options (Online & COD)", "Real-time order tracking", "Professional and verified service providers", "Competitive pricing", "24/7 customer support"];
  const stats = [{
    number: "10,000+",
  ...
  return <div className="min-h-screen bg-gradient-to-b from-[#FEFEFE] to-[#F5E6D3]">
      {}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 sm:h-20">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              <Link to="/login" className="px-3 sm:px-4 md:px-6 py-2 sm:py-2.5 text-xs sm:text-sm font-semibold text-gray-700 hover:text-[#D2A752] transition-colors">
                Login
              </Link>
              <Link to="/signup" className="px-3 sm:px-4 md:px-6 py-2 sm:py-2.5 text-xs sm:text-sm font-semibold text-white rounded-lg transition-all duration-300 hover:shadow-lg" style={{
              background: '#D2A752'
            }}>
                Get Started
              </Link>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
                <Link to="/signup" className="px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base font-bold text-white rounded-lg transition-all duration-300 hover:shadow-xl flex items-center justify-center gap-2" style={{
                background: '#D2A752'
              }}>
                  Get Started <FaArrowRight />
                </Link>
                <Link to="/login" className="px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base font-bold border-2 rounded-lg transition-all duration-300 hover:shadow-lg flex items-center justify-center gap-2" style={{
                borderColor: '#D2A752',
                color: '#D2A752'
              }}>
                  Learn More
            ...
            <div className="relative">
              <img src="https://images.unsplash.com/photo-1621905251918-48416bd8575a?w=800&h=600&fit=crop" alt="Professional Plumber" className="rounded-2xl shadow-2xl w-full h-auto" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            {stats.map((stat, index) => <div key={index} className="text-center">
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2" style={{
              color: '#D2A752'
            }}>
                  {stat.number}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 hover:shadow-xl transition-shadow">
              <div className="flex items-center justify-center w-16 h-16 rounded-full mb-4 sm:mb-6 mx-auto" style={{
              background: '#F5E6D3'
            }}>
                <FaUser className="text-3xl" style={{
                color: '#D2A752'
              }} />
              </div>
              ...
              <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base text-gray-600 mb-6">
                <li className="flex items-start gap-2">
                  <FaCheckCircle className="mt-1 flex-shrink-0" style={{
                  color: '#D2A752'
                }} />
              ...
              <Link to="/login" className="block w-full text-center px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base font-semibold text-white rounded-lg transition-all duration-300 hover:shadow-lg" style={{
              background: '#D2A752'
            }}>
                Login as Customer
              </Link>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 hover:shadow-xl transition-shadow">
              ...
              background: '#F5E6D3'
                ...
                <FaWrench className="text-3xl" style={{
                color: '#D2A752'
              }} />
              </div>
              ...
              <Link to="/plumber-login" className="block w-full text-center px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base font-semibold text-white rounded-lg transition-all duration-300 hover:shadow-lg" style={{
              background: '#D2A752'
            }}>
                Login as Plumber
              </Link>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 hover:shadow-xl transition-shadow">
              ...
              background: '#F5E6D3'
                ...
                <FaStore className="text-3xl" style={{
                color: '#D2A752'
              }} />
              </div>
              ...
              <Link to="/seller-login" className="block w-full text-center px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base font-semibold text-white rounded-lg transition-all duration-300 hover:shadow-lg" style={{
              background: '#D2A752'
            }}>
                Login as Seller
              </Link>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {features.map((feature, index) => <div key={index} className="bg-gradient-to-br from-[#FEFEFE] to-[#F5E6D3] rounded-xl p-6 sm:p-8 hover:shadow-lg transition-shadow">
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-b from-[#F5E6D3] to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              <img src="https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=800&h=600&fit=crop" alt="Plumbing Services" className="rounded-2xl shadow-xl w-full h-auto" />
            </div>
            <div>
              ...
              <ul className="space-y-4">
                {benefits.map((benefit, index) => <li key={index} className="flex items-start gap-3">
                    <FaCheckCircle className="mt-1 flex-shrink-0 text-xl" style={{
                  color: '#D2A752'
                }} />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto">
            <div className="bg-gradient-to-br from-[#FEFEFE] to-[#F5E6D3] rounded-xl p-6 sm:p-8 text-center">
              <FaCreditCard className="text-5xl mx-auto mb-4" style={{
              color: '#D2A752'
            }} />
            ...
            <div className="bg-gradient-to-br from-[#FEFEFE] to-[#F5E6D3] rounded-xl p-6 sm:p-8 text-center">
              <FaHandshake className="text-5xl mx-auto mb-4" style={{
              color: '#D2A752'
            }} />
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-b from-white to-[#F5E6D3]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
            {reviews.map((review, index) => <div key={index} className="bg-white rounded-xl p-6 sm:p-8 shadow-lg">
                <div className="flex items-center gap-1 mb-4" style={{
              color: '#D2A752'
            }}>
                  {[...Array(review.rating)].map((_, i) => <FaStar key={i} className="text-lg" />)}
                </div>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-r from-[#D2A752] to-[#B8943F] text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/signup" className="px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base font-bold bg-white text-[#D2A752] rounded-lg transition-all duration-300 hover:shadow-xl flex items-center justify-center gap-2">
              Create Account <FaArrowRight />
            </Link>
            <Link to="/login" className="px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base font-bold border-2 border-white text-white rounded-lg transition-all duration-300 hover:bg-white hover:text-[#D2A752] flex items-center justify-center gap-2">
              Login Now
            </Link>
          </div>
        </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li><button onClick={() => window.scrollTo({
                  top: 0,
                  behavior: 'smooth'
                })} className="hover:text-[#D2A752] transition-colors text-left">About Us</button></li>
                <li><button onClick={() => window.scrollTo({
                  top: document.body.scrollHeight,
                  behavior: 'smooth'
                })} className="hover:text-[#D2A752] transition-colors text-left">Contact</button></li>
              </ul>
            </div>
            <div>
