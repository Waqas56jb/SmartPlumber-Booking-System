            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5 flex-1 flex flex-col">
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="email" id="seller_email" name="seller_email" value={formData.seller_email} onChange={handleChange} placeholder="Enter your email address" className="w-full pl-9 sm:pl-10 md:pl-12 pr-3 sm:pr-4 h-11 sm:h-12 text-sm sm:text-base bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 transition-all duration-300 text-gray-900 placeholder:text-gray-400 shadow-sm" style={{
              ...
              <div className="flex items-center justify-end">
                <Link to="/seller-forgot-password" className="text-xs sm:text-sm font-medium transition-colors" style={{
                color: '#D2A752'
              ...
              <div className="text-center pt-4 mt-auto">
                <p className="text-xs sm:text-sm text-gray-500">
                  ...
                  <Link to="/seller-signup" className="font-semibold transition-colors" style={{
                  color: '#D2A752'
                }} onMouseEnter={e => e.target.style.color = '#B8943F'} onMouseLeave={e => e.target.style.color = '#D2A752'}>
                    Sign Up
                  </Link>
