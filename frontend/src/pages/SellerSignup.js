            ...
            <div className="mb-5 sm:mb-6 text-center">
              <div className="flex items-center justify-center mb-3">
                ...
                background: '#F5E6D3'
                  ...
                  <FaStore className="text-2xl sm:text-3xl" style={{
                  color: '#D2A752'
                }} />
                </div>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5 flex-1 flex flex-col">
              <div>
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-2.5 sm:pl-3 md:pl-4 flex items-center pointer-events-none">
                    <FaUser className="text-gray-400" size={14} style={{
                    fontSize: 'clamp(14px, 2.5vw, 16px)'
                  }} />
                  </div>
                  <input type="text" id="seller_username" name="seller_username" value={formData.seller_username} onChange={handleChange} placeholder="Enter your seller username" className="w-full pl-9 sm:pl-10 md:pl-12 pr-3 sm:pr-4 h-11 sm:h-12 text-sm sm:text-base bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 transition-all duration-300 text-gray-900 placeholder:text-gray-400 shadow-sm" style={{
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="email" id="seller_email" name="seller_email" value={formData.seller_email} onChange={handleChange} placeholder="Enter your seller email" className="w-full pl-9 sm:pl-10 md:pl-12 pr-3 sm:pr-4 h-11 sm:h-12 text-sm sm:text-base bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 transition-all duration-300 text-gray-900 placeholder:text-gray-400 shadow-sm" style={{
                  '--tw-ring-color': '#D2A752'
                }} onFocus={e => {
                  e.target.style.boxShadow = '0 0 0 2px #D2A752';
                  e.target.style.borderColor = '#D2A752';
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type={showPassword ? 'text' : 'password'} id="seller_password" name="seller_password" value={formData.seller_password} onChange={handleChange} placeholder="Create a seller password" className="w-full pl-9 sm:pl-10 md:pl-12 pr-9 sm:pr-10 md:pr-12 h-11 sm:h-12 text-sm sm:text-base bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 transition-all duration-300 text-gray-900 placeholder:text-gray-400 shadow-sm" style={{
                  '--tw-ring-color': '#D2A752'
                }} onFocus={e => {
                  e.target.style.boxShadow = '0 0 0 2px #D2A752';
                  e.target.style.borderColor = '#D2A752';
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type={showConfirmPassword ? 'text' : 'password'} id="confirm_seller_password" name="confirm_seller_password" value={formData.confirm_seller_password} onChange={handleChange} placeholder="Confirm your seller password" className="w-full pl-9 sm:pl-10 md:pl-12 pr-9 sm:pr-10 md:pr-12 h-11 sm:h-12 text-sm sm:text-base bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 transition-all duration-300 text-gray-900 placeholder:text-gray-400 shadow-sm" style={{
                  '--tw-ring-color': '#D2A752'
                }} onFocus={e => {
                  e.target.style.boxShadow = '0 0 0 2px #D2A752';
                  e.target.style.borderColor = '#D2A752';
                  ...
                  <button type="button" onClick={() => setShowConfirmPassword(!showConfirmPassword)} className="absolute inset-y-0 right-0 pr-3 sm:pr-4 flex items-center text-gray-400 transition-colors" onMouseEnter={e => e.target.style.color = '#D2A752'} onMouseLeave={e => e.target.style.color = '#9CA3AF'}>
                    {showConfirmPassword ? <FaEyeSlash size={16} /> : <FaEye size={16} />}
                  </button>
                </div>
                {formData.confirm_seller_password && formData.seller_password === formData.confirm_seller_password && <div className="flex items-center gap-2 text-xs sm:text-sm text-green-600 mt-2">
              ...
              <div className="text-center pt-4 mt-auto">
                <p className="text-xs sm:text-sm text-gray-500">
                  ...
                  <Link to="/seller-login" className="font-semibold transition-colors" style={{
                  color: '#D2A752'
