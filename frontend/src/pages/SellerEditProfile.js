...
const SellerEditProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // const response = await sellerAPI.updateSellerProfile(user.id, formData);
  ...
  const tabs = [
    { id: 'shop', label: 'Shop Info', icon: FaStore },
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              disabled={saving}
              className="px-6 py-3 rounded-xl font-semibold text-white transition-all flex items-center gap-2 hover:shadow-lg disabled:opacity-50"
              ...
              return (
                <button
                  ...
                  className={`flex-1 px-4 py-4 text-sm font-semibold transition-all flex items-center justify-center gap-2 ${
                    activeTab === tab.id
                      ? 'text-[#D2A752] border-b-2 border-[#D2A752] bg-[#F5E6D3]/30'
        ...
        <form onSubmit={handleSubmit}>
              ...
              <div className="border-t pt-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {[1, 2, 3, 4].map((idx) => (
                    <div
                      key={idx}
                      className="aspect-square rounded-xl border-2 border-dashed border-gray-300 flex flex-col items-center justify-center bg-gray-50 hover:bg-gray-100 cursor-pointer transition-all"
                    >
          ...
          <div className="mt-6 md:hidden">
            <button
              type="submit"
              disabled={saving}
              className="w-full px-6 py-4 rounded-xl font-semibold text-white transition-all flex items-center justify-center gap-2 hover:shadow-lg disabled:opacity-50"
              style={{ background: '#D2A752' }}
            >
              {saving ? (
                <>
