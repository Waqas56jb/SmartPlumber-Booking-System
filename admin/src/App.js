...
const App = () => {
  ...
  return <div className="min-h-screen flex bg-slate-950 text-slate-100">
      <Sidebar items={menuItems} active={activePage} onChange={setActivePage} onLogout={handleLogout} logoutIcon={<FiLogOut />} />
