...
const Sellers = ({ apiBase }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {loading ? (
        <div className="text-slate-300 text-sm">Loading sellers from database...</div>
      ) : sellers.length === 0 ? (
            ...
            <div className="space-y-3 text-sm">
              <div>
                ...
                <input
                  ...
                  value={editing.seller_shop_name || ''}
                  onChange={(e) => setEditing({ ...editing, seller_shop_name: e.target.value })}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  max="5"
                  className="w-full px-3 py-2 rounded-lg bg-slate-950 border border-slate-700 text-slate-100 text-sm"
                  value={editing.seller_rating || 0}
                  onChange={(e) =>
                    setEditing({ ...editing, seller_rating: parseFloat(e.target.value) || 0 })
                  }
                />
              </div>
            </div>
